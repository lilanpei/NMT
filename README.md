...
2) We use only Mircoblog set in UM-Corpus to reduce the memory and time consumption of training, but it will be worthwhile testing on the full scale dataset.  
